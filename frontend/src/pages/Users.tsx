          ...
          <div className="bg-[#2F3136] rounded p-4">
            ...
            <div className="mt-2 space-y-2">
              <button
                ...
                className={`w-full p-2 rounded text-white focus:outline-none transition-all duration-300 ${filterGroup === 'staff'
                  ? 'bg-[#3e4147]'
              ...
              <button
                ...
                className={`w-full p-2 rounded text-white focus:outline-none transition-all duration-300 ${filterGroup === 'student'
                  ? 'bg-[#3e4147]'
                  : 'bg-[#36393F] hover:bg-[#3e4147]'
                }`}
              >
              ...
              <button
	                ...
	                className={`w-full p-2 rounded text-white focus:outline-none transition-all duration-300 ${filterGroup === 'null'
	                    ? 'bg-[#3e4147]'
	                    : 'bg-[#36393F] hover:bg-[#3e4147]'
	                }`}
              >
